...
API_KEY = "725c9d912f58451ca0f674c9632cae49"
SITE_URL = "https://api.themoviedb.org/3/search/movie"
DETAILS_API = "https://api.themoviedb.org/3/movie/{movie_id}"
...
def find_movie():
    ...
    if movie_api_id:
        ...
        new_movie = Movie(
            ...
            img_url=f"{f'https://image.tmdb.org/t/p/w500'}{data['poster_path']}",
